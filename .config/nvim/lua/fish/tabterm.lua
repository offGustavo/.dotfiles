...
config = vim.tbl_extend("force", config, vim.g.tabterm_config or {})
...
local function create_split(new)
  -- TASK(20260105-221020): this must be inverted
  if not new then
...
-- TASK(20260105-220542): invert the logic here, first check if it's a tabterm window, then ask for the new name.
